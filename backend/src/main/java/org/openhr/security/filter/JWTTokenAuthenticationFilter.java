...
public class JWTTokenAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
  ...
  public JWTTokenAuthenticationFilter(final RequestMatcher requiresAuthenticationRequestMatcher,
  ...
  public Authentication attemptAuthentication(final HttpServletRequest request, final HttpServletResponse response)
    ...
    final String rawToken = tokenPayload.substring(SecurityConfigConstants.TOKEN_PREFIX.length(), tokenPayload.length());
