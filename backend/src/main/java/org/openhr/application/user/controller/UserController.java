...
public class UserController {
  ...
  public void updateNotificationsSettings(@PathVariable final long userId,
                                          @RequestParam final boolean notificationsTurnedOn) throws UserDoesNotExist {
    userFacade.updateNotificationsSettings(userId, notificationsTurnedOn);
  }

  @RequestMapping(value = "/auth/{userId}", method = RequestMethod.PUT, consumes = {MediaType.APPLICATION_JSON_VALUE},
    produces = {MediaType.APPLICATION_JSON_VALUE})
  @ResponseStatus(HttpStatus.NO_CONTENT)
  @ResponseBody
