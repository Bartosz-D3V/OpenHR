...
export class ManageDelegationApplicationsComponent implements OnInit, OnDestroy {
  ...
  public displayedColumns: Array<string> = ['applicationId', 'from', 'to', 'employeeName',
    'country', 'city', 'budget', 'reject', 'approve'];
  public dataSource: MatTableDataSource<DelegationApplication>;

  @ViewChild(MatPaginator)
  public paginator: MatPaginator;

  constructor(private _manageDelegationApplicationsService: ManageDelegationApplicationsService,
  ...
  public fetchDelegationApplications(): void {
    ...
    this.$delegationApplications = this._manageDelegationApplicationsService
      ...
      .subscribe((result: Array<DelegationApplication>) => {
  ...
  public approveDelegationApplication(processInstanceId: string): void {
    this._manageDelegationApplicationsService
      .approveDelegationApplicationByManager(processInstanceId)
      .subscribe(() => {
        this.fetchDelegationApplications();
  ...
  public rejectDelegationApplication(processInstanceId: string): void {
    this._manageDelegationApplicationsService
      .rejectDelegationApplicationByManager(processInstanceId)
      .subscribe(() => {
        this.fetchDelegationApplications();
