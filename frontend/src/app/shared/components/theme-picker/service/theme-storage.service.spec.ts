...
describe('ThemeStorageService', () => {
  ...
  it('storeTheme should store theme in localStore and emmit its data',
  ...
  describe('getStoredTheme', () => {
    it('should return theme from localStorage if it exists',
      inject([ThemeStorageService], (service: ThemeStorageService) => {
    ...
    it('should return null if there is no stored theme in localStorage',
      inject([ThemeStorageService], (service: ThemeStorageService) => {
